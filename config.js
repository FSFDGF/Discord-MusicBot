module.exports = {
	...
	token: process.env.token || "MTE2Mjg4NDM5Njg3Mzk0OTI4NQ.GM7Agw.b8MH5ypsPkHkPM7ePNgUXU5AJ3FjJOf78Tzz2I", //- Bot's Token
	clientId: process.env.clientId || "1162884396873949285", //- ID of the bot
	clientSecret: process.env.clientSecret || "p3sJ1qzzf7UDpH6HvnkRDavHKmceRxrP", //- Client Secret of the bot
